...
function Worker() {
    ...
    const Sweets = require('./Sweetness/Sweets/Sweets.js');
    const Drops = require('./Sweetness/Drops/Drops.js');
    const Chokolate = require('./Sweetness/Chokolate/Chokolate.js');
    this.start = function () {
        prompt.start();
        ...
        function calculateWeight(arr) {
            let total= 0;
            arr.forEach(function(item){ // reduce;
